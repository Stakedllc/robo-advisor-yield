...
/// @dev  Slightly modified from the OpenZeppelin package version.
...
library SafeERC20 {
    ...
    /// @dev  Removed the logic which only allows this to be used when zeroing an
    ///       allowance or setting it for the first time.
